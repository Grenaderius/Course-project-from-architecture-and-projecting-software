...
public class GroupCategoryFinancesFinderCommand implements Command, FileChooserInterface {
    ...
    public void execute() {
        if(checkFileType()){
            ListsDivider listsDivider = new ListsDivider(returnListWithoutType(), typeForDividerChooser.getTypeForCategory());
            GroupAndCategoryFinancesCalculations groupAndCategoryFinancesCalculations = new GroupAndCategoryFinancesCalculations(listsDivider.returnListDivided());
