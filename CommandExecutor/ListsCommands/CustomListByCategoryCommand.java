...
public class CustomListByCategoryCommand implements Command, FileChooserInterface {
    ...
    public void execute() {
        if(checkFileType()){
            ListsCreator listsCreator = new ListsCreator(chosenFile, columnsChooser.getColumnsForCustoms());
            ListsDivider listsDivider = new ListsDivider(listsCreator.createList(), typeForDividerChooser.getTypeForCategory());
