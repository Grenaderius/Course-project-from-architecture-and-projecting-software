...
public class HotelsListsCreatorByCategoryCommand implements Command, FileChooserInterface {
    ...
    public void execute() {
        if(checkFileType()){
            ...
            //по категорії виводить тільки заголовок
            listsDivider = new ListsDivider(listsDivider.returnListDivided(), typeForDividerChooser.getTypeForCategory());
