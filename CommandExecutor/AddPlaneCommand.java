...
import Actions.AgencyActions.AddPlane.PlanesAdder;
...
public class AddPlaneCommand implements Command, FileChooserInterface{
    ...
    public void execute() {
        if(checkFileType()){
            PlanesAdder planesAdder = new PlanesAdder(chosenFile);
            planesAdder.createPlane();
